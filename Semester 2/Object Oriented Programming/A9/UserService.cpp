...
void UserService::setShoppingBasketType(std::string shoppingBasketType)
{
	if (shoppingBasketType == "CSV")
		this->shoppingBasket = new CsvShoppingBasket("shoppingBasket.csv");
	if (shoppingBasketType == "HTML")
		this->shoppingBasket = new HtmlShoppingBasket("shoppingBasket.html");
